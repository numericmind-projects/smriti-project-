...
kableExtra::kbl(table_2, caption = "", align = "l", escape = F, bootstrap_options = "basic") %>%
  kableExtra::kable_minimal(full_width = F, html_font = "Courier New") %>% 
  kableExtra::column_spec(3, extra_css = "") 
table_2 %>% knitr::kable(caption = "<center> Table 1.27 <br/> Summary of Substance Use at Entry </center> <br/>")
table_2
